...
export const skills: SkillBubble[] = [
  ...
  { title: "NHibernate", color: "27, 43, 52" }, // #1b2b34
  { title: "jQuery", color: "7, 105, 173" }, // #0769ad
  { title: "Bootstrap", color: "121, 82, 179" }, // #7952b3
  { title: "HTML", color: "227, 79, 38" }, // #e34f26
  { title: "CSS", color: "21, 114, 182" }, // #1572b6
  { title: "SCSS", color: "198, 83, 140" }, // #c6538c
  { title: "Git", color: "240, 80, 50" }, // #f05032
  { title: "Java", color: "0, 115, 150" }, // #007396
  { title: "MySQL", color: "68, 121, 161" }, // #4479a1
